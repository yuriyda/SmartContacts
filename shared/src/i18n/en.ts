...
export const en = {
  ...
  googleContacts: {
    ...
    desktopOnly: 'Google Contacts sync is available in the desktop (Tauri) build only.',
    phaseOneNotice:
    ...
    review: 'Review',
    conflictsTitle: 'Pending sync conflicts',
    connect: 'Connect Google',
    connecting: 'Connecting…',
    connectedToast: 'Connected to Google Contacts',
    connectFailed: 'Connect failed',
    setClientIdFirst: 'Set Client ID first',
    syncing: 'Syncing…',
    openInGoogle: 'Open in Google',
    disconnect: 'Disconnect',
    disconnectTitle: 'What to do with imported contacts?',
    keepLocal: 'Keep them as local',
    deleteAll: 'Delete them all',
    deleting: 'Deleting…',
    confirmDeleteTitle: 'Are you sure? This will permanently delete all imported contacts.',
    confirmDelete: 'Yes, delete them all',
    revokeHint: 'To revoke at Google: myaccount.google.com → Security → Third-party access',
  ...
  hotkey: {
    ...
    first: 'Jump to first',
    last: 'Jump to last',
    extend_first: 'Extend selection to first',
    extend_last: 'Extend selection to last',
    pgup: 'Page up',
    pgdn: 'Page down',
    extend_pgup: 'Extend selection page up',
    extend_pgdn: 'Extend selection page down',
    select_all: 'Select all visible',
  },
  ctx: {
    open: 'Open',
    edit: 'Edit',
    touch: 'Mark as contacted now',
    hide: 'Hide',
    unhide: 'Unhide',
    protect: 'Protect',
    unprotect: 'Unprotect',
